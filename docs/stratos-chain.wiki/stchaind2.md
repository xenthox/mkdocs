...
#### -[`create-resource-node`](#-create-resource-node)
...
```shell
stchaind tx register create-resource-node --network-address=<network-address> --amount=<amount> --pubkey=<pubkey of resource node> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --moniker=<name of resource node> --node-type=<resource node type, int 1~7>
```
Example:
```shell
 ./stchaind tx register create-resource-node --network-address=stsds1gl9ywg6jdfdgcja70ffum4ectq4fmt26ay4znv --amount=10stos --pubkey=stsdspub1zcjduepqmrsput8d8c4tqeztrwzjjntg0jdgvmuyd5pur2g0chpxv5cccdsq4drddm --from=user0 --moniker=resource-node0 --node-type=1 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### -[`update-resource-node`](#-update-resource-node)
...
```shell
stchaind tx register update-resource-node --network-address=<resourceNode_address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --moniker=<name of resource node> --node-type=<resource node type, int 1~7>
```

Example:
```shell
stchaind tx register update-resource-node --network-address=stsds1gl9ywg6jdfdgcja70ffum4ectq4fmt26ay4znv --from=user0 --moniker=resource-nodeupdate --node-type=7 --chain-id=tropos-5  --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### -[`update-resource-node-stake`](#-update-resource-node-stake)
...
```shell
stchaind tx register update-resource-node-stake --network-address=<resource_node_address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --stake-delta=<delta_amount> --incr-stake=<bool> --gas=auto
```
Example:
```shell
./stchaind tx register update-resource-node --network-address=stsds1gl9ywg6jdfdgcja70ffum4ectq4fmt26ay4znv --from=user0 --moniker=resource-nodeupdate --node-type=7 --chain-id=tropos-5  --keyring-backend=test --gas=auto --gas-prices=1000000000wei
```
...
#### -[`remove-resource-node`](#-remove-resource-node)
...
```shell
stchaind tx register remove-resource-node --network-address=<resource_node_address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
./stchaind tx register remove-resource-node --network-address=stsds1gl9ywg6jdfdgcja70ffum4ectq4fmt26ay4znv --from=user0 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### -[`create-meta-node`](#-create-meta-node)
...
```shell
stchaind tx register create-meta-node --network-address=<network-address> --amount=<amount> --pubkey=<pubkey of meta node> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --moniker=<name of resource node>
```
Example:
```shell
./stchaind tx register create-meta-node --network-address=stsds1faej5w4q6hgnt0ft598dlm408g4p747y4krwca --amount=10stos --pubkey=stsdspub1zcjduepqv7sj69c52rsdu5m8nk6tg4v5y8fh43w2hl9aa7mp3qgr9ym0feyshrc4wv --from=user0 --moniker=meta-node0 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y

```
</details>
<br>

#### -[`meta-node-reg-vote`](#-meta-node-reg-vote)
...
| :warning: A newly-created meta node needs 7 days by default to be voted by other active meta nodes |
|:--------------------------------------------------------------------------------------------------|
...
```shell
stchaind tx register meta-node-reg-vote --candidate-network-address=<candidate-network-address> --candidate-owner-address=<candidate-owner-address> --opinion=<true|false> --voter-network-address=<voter-network-address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
./stchaind tx register meta-node-reg-vote --candidate-network-address=stsds1faej5w4q6hgnt0ft598dlm408g4p747y4krwca --from=st1pvyjzlhwrpgklu0044at4t6qh7m23k3kr2gsjh --candidate-owner-address=st1pvyjzlhwrpgklu0044at4t6qh7m23k3kr2gsjh --opinion=true --voter-network-address=stsds13yakj2xgzzdfcw7kd5gtfcfv2k6sn5eg4vdfem --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei
```
...
#### -[`update-meta-node`](#-update-meta-node)
Update ma node info
```shell
Usage:
...
```shell
stchaind tx register update-meta-node --network-address<network-address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --moniker=<name of meta node>
```
Example:
```shell
./stchaind tx register update-meta-node --network-address=stsds1faej5w4q6hgnt0ft598dlm408g4p747y4krwca --from=st1pvyjzlhwrpgklu0044at4t6qh7m23k3kr2gsjh --moniker=meta-node --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### -[`remove-meta-node`](#-remove-meta-node)
Remove an meta node
```shell
Usage:
...
```shell
stchaind tx register remove-meta-node --network-address=<meta_node_address> --from=owner_address> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --gas=auto
```
Example:
```shell
./stchaind tx register remove-meta-node --network-address=stsds1faej5w4q6hgnt0ft598dlm408g4p747y4krwca --from=st1pvyjzlhwrpgklu0044at4t6qh7m23k3kr2gsjh --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### -[`update-meta-node-stake`](#-update-meta-node-stake)
...
```shell
stchaind tx register update-meta-node-stake --network-address=<meta_node_address> --from=<owner_address> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --stake-delta=<delta_amount> --incr-stake=<true|false>
```
Example:
```shell
./stchaind tx register update-meta-node-stake --network-address=stsds1faej5w4q6hgnt0ft598dlm408g4p747y4krwca --from=st1pvyjzlhwrpgklu0044at4t6qh7m23k3kr2gsjh --stake-delta=100gwei --incr-stake=true --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
...
#### [`get-resource-nodes`](#get-resource-nodes)
...
#### [`get-resource-count`](#get-resource-count)
...
```shell
stchaind tx sds upload --file-hash=<file hash> --uploader=<file uploader, owner address of resource node> --reporter=<file reporter, meta node address> --from=<Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
 ./stchaind tx sds upload --file-hash=001A1FC0B82DD3B0353B59E90388EEA2B73DEECA872955B414EBC99ECD3E3C1F --uploader=st16uzr20lx072gexwjuvg94hz3t8y73u4085s9sw --reporter=stsds14c3em44vlh276cujnr2ez802uyjyeqrrsu9fuh --from=user0 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
</details>
<br>
...
```shell
stchaind tx sds prepay <from_address, Name|address of private key> <coins> --chain-id=<current chain-id> --keyring-backend=<keyring's backend> --gas=auto
```
Example:
```shell
 ./stchaind tx sds prepay user0 10stos --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
</details>
<br>
...
[//]: # (  stchaind query sds prepay [acct_addr] [flags])
...
[//]: # (stchaind query sds prepay <acct_addr>)
...
[//]: # (./stchaind query sds prepay st16uzr20lx072gexwjuvg94hz3t8y73u4085s9sw)
...
```shell
stchaind tx pot foundation-deposit --amount=<amount> --from=<from_address, Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
$ ./stchaind tx pot foundation-deposit --amount=40000stos --from=user0 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei
```
</details>
<br>
...
```shell
stchaind tx pot withdraw --amount=<amount to withdraw> --target-address=<wallet address of reciever> --from=<from_address, Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
$ ./stchaind tx pot withdraw --amount=100utros --target-address=st1sqzsk8mplv5248gx6dddzzxweqvew8rtst96fx --from=user0 --chain-id=tropos-5  --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
</details>
<br>


#### -[`legacy-withdraw`](#-legacy-withdraw)
...
```shell
stchaind tx pot legacy-withdraw --amount=<amount to withdraw> --target-address=<wallet address of reciever> --from=<from_address, Name|address of private key> --chain-id=<current chain-id> --keyring-backend=<keyring's backend>
```
Example:
```shell
$ ./stchaind tx pot legacy-withdraw --amount=100utros --target-address=st1sqzsk8mplv5248gx6dddzzxweqvew8rtst96fx --from=user0 --chain-id=tropos-5 --keyring-backend=test --gas=auto --gas-prices=1000000000wei -y
```
</details>
<br>
...
```
<details>
  <summary><b>Create Configuration Example</b></summary>
...
<details>
  <summary><b>Query Configuration Example</b></summary>
...
### [`tendermint-validator-set`](#tendermint-validator-set)
...
```shell
$ ./stchaind query txs --events 'message.sender=st1gtw399h9vfnekqsz3dg4n6mj0qgdpnh3c2n66k' --chain-id=tropos-5 --limit=20
  {
    "total_count": "2",
    "count": "2",
    "page_number": "1",
